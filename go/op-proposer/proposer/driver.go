...
import (
	...
	"github.com/ethereum-optimism/optimism/go/op-proposer/bindings"
	"github.com/ethereum-optimism/optimism/go/op-proposer/contracts"
	"github.com/ethereum-optimism/optimism/go/op-proposer/metrics"
)
...
func NewL2OutputSubmitter(setup DriverSetup) (_ *L2OutputSubmitter, err error) {
	...
	if setup.Cfg.L2OutputOracleAddr != nil {
		...
		panic("we don't support submit state to l2 output oracle")
