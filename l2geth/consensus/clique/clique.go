...
// SyncSeal seals a block synchronously, avoid concurrent sealing attempts which might break the mips execution.
func (c *Clique) SyncSeal(chain consensus.ChainReader, block *types.Block) error {
	header := block.Header()
